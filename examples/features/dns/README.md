...
resources:
- dnsutils.yaml
- https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/b53b2de490086a26767f7a8cd39baaadfd205db3/examples/features/dns/coredns-config-map.yaml
