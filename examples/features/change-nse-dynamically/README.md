...
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/features/change-nse-dynamically
```

```bash
kubectl apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/features/change-nse-dynamically/green-netsvc.yaml
```
