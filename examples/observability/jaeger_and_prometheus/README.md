...
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/observability/jaeger_and_prometheus
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/observability/jaeger_and_prometheus/example
```
