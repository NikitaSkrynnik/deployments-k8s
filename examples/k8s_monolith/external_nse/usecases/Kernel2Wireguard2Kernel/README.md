...
```bash
NAMESPACE=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/5cdd12cbbfa63a3c78992d558892f1120195735c/examples/k8s_monolith/external_nse/usecases/namespace.yaml)[0])
