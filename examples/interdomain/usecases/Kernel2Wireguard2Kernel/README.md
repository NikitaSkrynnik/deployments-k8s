...
```bash
NAMESPACE1=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/13b63b79926a5b1b5a33f99b6a5208b4e0a04c2a/examples/interdomain/usecases/namespace.yaml)[0])
...
Create test namespace:
```bash
NAMESPACE2=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/13b63b79926a5b1b5a33f99b6a5208b4e0a04c2a/examples/interdomain/usecases/namespace.yaml)[0])
