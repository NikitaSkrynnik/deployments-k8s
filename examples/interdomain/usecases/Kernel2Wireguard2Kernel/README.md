...
```bash
NAMESPACE1=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9d094bad1380ec0e79bf44ad73e8a4d2e2c2b1fd/examples/interdomain/usecases/namespace.yaml)[0])
...
Create test namespace:
```bash
NAMESPACE2=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/9d094bad1380ec0e79bf44ad73e8a4d2e2c2b1fd/examples/interdomain/usecases/namespace.yaml)[0])
