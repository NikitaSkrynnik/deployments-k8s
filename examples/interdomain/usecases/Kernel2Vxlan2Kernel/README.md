...
```bash
NAMESPACE1=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e4fc40f3cc9dad1a6dab55b1c0995a598a3a3c99/examples/interdomain/usecases/namespace.yaml)[0])
...
Create test namespace:
```bash
NAMESPACE2=($(kubectl create -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/e4fc40f3cc9dad1a6dab55b1c0995a598a3a3c99/examples/interdomain/usecases/namespace.yaml)[0])
