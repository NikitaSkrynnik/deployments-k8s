...
grep 'ref=3bc492f2fc6d0713c7efefb835def421c996cc49' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=3bc492f2fc6d0713c7efefb835def421c996cc49[a-z0-9]*/${root}\/\2/g" "${file}"
done
