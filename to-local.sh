...
grep 'ref=f4d6904289dd50f9063d88a6d6e2457c73ac6088' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=f4d6904289dd50f9063d88a6d6e2457c73ac6088[a-z0-9]*/${root}\/\2/g" "${file}"
done
