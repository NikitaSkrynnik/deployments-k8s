...
grep 'ref=d62431a762ee5469976cc48098fa4a9cd1a8c3af' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=d62431a762ee5469976cc48098fa4a9cd1a8c3af[a-z0-9]*/${root}\/\2/g" "${file}"
done
