...
grep 'ref=9d3cda0a20d858862ce10d2d07cdb84a9b5c056a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9d3cda0a20d858862ce10d2d07cdb84a9b5c056a[a-z0-9]*/${root}\/\2/g" "${file}"
done
