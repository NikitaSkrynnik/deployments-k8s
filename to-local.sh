...
grep 'ref=e34c66b2d729db882afe6b4068401160aa31756a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=e34c66b2d729db882afe6b4068401160aa31756a[a-z0-9]*/${root}\/\2/g" "${file}"
done
