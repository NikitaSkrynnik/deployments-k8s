...
grep 'ref=4a1e7dfb2f46877f26483b26c6d43678d54e7d63' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=4a1e7dfb2f46877f26483b26c6d43678d54e7d63[a-z0-9]*/${root}\/\2/g" "${file}"
done
