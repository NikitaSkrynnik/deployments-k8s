...
grep 'ref=5fc43f52c22fa18ebb0bf9a131185b799487d83a' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=5fc43f52c22fa18ebb0bf9a131185b799487d83a[a-z0-9]*/${root}\/\2/g" "${file}"
done
