...
grep 'ref=9d094bad1380ec0e79bf44ad73e8a4d2e2c2b1fd' -rl examples/* | while IFS= read -r file; do
  root="$(get_root "$file")"
  sedi -E "s/(https:\/\/)?github.com\/networkservicemesh\/deployments-k8s\/(.*)\?ref=9d094bad1380ec0e79bf44ad73e8a4d2e2c2b1fd[a-z0-9]*/${root}\/\2/g" "${file}"
done
